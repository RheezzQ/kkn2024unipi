...
import ChartJenisKelamin from "@/components/Charts/ChartJenisKelamin";
import Table from "@/components/Table/TableJenisKelamin";
          ...
          <div className="flex flex-wrap -mx-4">
            <div className="w-full px-4 lg:w-3/4">
              <div className="blog-details blog-details-docs rounded-sm bg-white py-11 px-8 shadow-three dark:bg-gray-dark sm:p-[55px] lg:mb-5 lg:px-8 xl:p-[55px]">
                <h2>Data Statistik Jenis Kelamin</h2>
