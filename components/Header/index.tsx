    ...
    >
      <div className="mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0 lg:flex items-center justify-between relative">
        <div className="w-full lg:w-1/4 flex items-center justify-between">
          <a href="/">
            <Image
              src="/images/logo/Konfigurfi Logo-06.png"
              alt="logo"
              width={50.03}
              height={20}
          ...
          <h2 className="font-bold text-black">KKN UNIPI 2024 </h2>
        ...
        >
          <nav>
            <ul className="flex justify-center lg:items-center flex-col lg:flex-row gap-5 lg:gap-10 pl-35">
